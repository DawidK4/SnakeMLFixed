...
class SnakeGameAI:
    ...
    def __init__(self, w=640, h=480):
        ...
        self.snake_body_bend_rd = pygame.image.load('Photos/Snake_Bend/RD.png')
        self.snake_body_bend_ld = pygame.image.load('Photos/Snake_Bend/LD.png')
        self.snake_body_bend_ru = pygame.image.load('Photos/Snake_Bend/RU.png')
        self.snake_body_bend_lu = pygame.image.load('Photos/Snake_Bend/LU.png')
